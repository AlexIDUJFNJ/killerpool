> ⚠️ **Исторический документ.** Снимок состояния на 23 ноября 2025 года; он не
> обновлялся и не описывает текущий проект. Здесь ещё Next.js 15, Tailwind 3.4,
> Node 20, семь достижений и Background Sync — всё это с тех пор изменилось.
> Ценность документа в другом: это датированный лог решений, отвечающий на
> вопрос «почему так сделали».
>
> Актуальное состояние: [ARCHITECTURE.md](./ARCHITECTURE.md) (архитектура),
> [README.md](./README.md) (стек и возможности).
