...
-- Migration: 00003_fix_leaderboard_and_profile
-- Description: Fix leaderboard RLS issue and profile update issue
-- ====================================

-- ====================================
-- FIX 1: Add UNIQUE constraint on user_id in player_profiles
...
-- ====================================
-- FIX 2: Update get_leaderboard function to use SECURITY DEFINER
-- This allows the function to bypass RLS and read all completed games
-- ====================================
...
COMMENT ON FUNCTION get_leaderboard IS 'Returns top N players ranked by win rate and total wins from completed games (SECURITY DEFINER to bypass RLS)';
