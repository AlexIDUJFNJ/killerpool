...
- ✅ Улучшен UX для лидерборда: маркетинговые сообщения для незарегистрированных игроков
- ✅ Добавлена документация по архитектуре лидерборда и требованиям авторизации
